...
import { AddPromotionSectionDataAPI, GetPromotionSectionDataAPI, UpdatePromotionSectionDataAPI } from "../../../../../../API/CMS";
...
const PromotionSection = () => {
  ...
  const AddSectionData = async () => {
    ...
    if (data._id) {
      res = await UpdatePromotionSectionDataAPI(data._id, formData)
      if (res.error != null) {
      ...
      res = await AddPromotionSectionDataAPI(formData)
      if (res.error != null) {
        toast.error(res.error, {
          position: "top-right",
          autoClose: 3000,
              ...
              {enteredData.video ? (
                <>
                  <video controls className="uploaded_img">
                    <source src={enteredData.video.link} type="video/mp4" />
                  </video>
                </>
              ) : (
                <>
